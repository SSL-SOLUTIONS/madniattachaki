  ...
  <body class="navbody" >
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="{{url('/')}}" class="text-white mb-0"><img src="{{asset('website/navbar/images/logo.png')}}" alt=""></a></h1>
          </div>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="https://sunridgefoods.com/assets/video/product-page-header-20230727.mp4" type="video/mp4">
